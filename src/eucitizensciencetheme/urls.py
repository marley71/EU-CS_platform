...
urlpatterns = [
    ...
    path('get_projects_bdsweek/<int:anno>/', views.get_projects_bdsweek, name='get_projects_bdsweek'),
    ...
    path("bdsweek_map/<int:anno>/", views.bdsweek_projects_map, name="bdsweek_map_anno"),
